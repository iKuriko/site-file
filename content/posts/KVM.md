---
title: "KVM"
date: 2021-11-05T16:36:54+08:00
draft: true
---
...
```
qemu-img create -f qcow2 /kvm/store/CentOS-7.9_01.qcow2 20G
```
...
创建虚拟机（网络模式设置桥接主机，自定义网卡br0，使用自定义网络）

```bash
virt-install --virt-type=kvm --name=CentOS7.9_01 --os-type=linux --vcpus=1 --memory=1024 --location=/iso/CentOS-7-x86_64-Minimal-2009.iso --disk=/kvm/store/CentOS-7.9_01.qcow2,size=20,format=qcow2 --network bridge=br0,model=virtio --accelerate --autostart --extra-args='console=ttyS0'
```
